...
const translations: Record<Lang, Record<string, TranslationValue>> = {
  en: {
    ...
    'plan.pro': 'Pro',
    'plan.pro.desc': 'For growing stores that need full control',
    'plan.pro.features': [
      'Everything in Mini',
    ...
    'plan.pro.modules': 'Self-Checkout + Inventory + Fraud Detection',
    ...
    'plan.growth.features': [
      ...
      'Churn Radar + Auto-Winback Campaigns',
      'Staff Verification + Manpower',
      'Automated GST Reports (CA-grade export)',
      'Dedicated Account Manager',
    ],
    'plan.growth.modules': 'Everything in Pro + Multi-Store Analytics + Staff Verification',

    'plan.business': 'Business',
    'plan.business.desc': 'For operators running multiple businesses or brands',
    'plan.business.features': [
      'Everything in Growth, across every business',
      'Multiple Tenants — manage separate businesses in one login',
      'Custom Integrations + ERP API Access',
      'Dedicated Infrastructure & SLA',
      'White-Glove Onboarding',
      '24/7 Priority Support',
    ],
    'plan.business.modules': 'Everything in Growth + Custom Integrations + Dedicated Support',
  ...
  hi: {
    ...
    'plan.pro': 'Pro',
    'plan.pro.desc': 'Poora control chahne wali badhti dukaano ke liye',
    'plan.pro.features': [
      'Mini ka sab kuch',
      'Full Inventory + Low-Stock Alerts',
      'AI Fraud Detection',
    ...
    'plan.growth.modules': 'Pro ka sab kuch + Multi-Store Analytics + Staff Verification',

    'plan.business': 'Business',
    'plan.business.desc': 'Multiple businesses ya brands chalane wale operators ke liye',
    'plan.business.features': [
      'Growth ka sab kuch, har ek business ke liye',
      'Multiple Tenants — alag-alag businesses ek hi login mein sambhalein',
      'Custom Integrations + ERP API Access',
      'Dedicated Infrastructure & SLA',
      'White-Glove Onboarding',
      '24/7 Priority Support',
    ],
    'plan.business.modules': 'Growth ka sab kuch + Custom Integrations + Dedicated Support',
